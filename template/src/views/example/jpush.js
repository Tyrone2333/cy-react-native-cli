...
export default class App extends React.Component {
    ...
    componentDidMount() {
        ...
        JPush.getRegistrationID(result => {
            // log(' JPush.getRegistrationID ', result)
            let registerID = typeof result === 'string' ? result : result.registerID

            // 第一次打开可能无法及时获取 registerID
            if (!registerID) {
                console.warn('JPush.getRegistrationID 没有获取到 registerID,无法绑定')
                return
            }
                ...
                <View style={styles.container}>
                    ...
                    <Button
                        ...
                        onPress={() =>
                            JPush.getRegistrationID(result =>
                                console.log(
                                    'registerID:' + JSON.stringify(result),
                                ),
                            )
                        }
                    />
